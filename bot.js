...
client.on("ready",  async () => {
  ...
  client.user.setActivity(`Placeholder 2.0`);
});
...
if(command === "about") {
	...
	__**Support Server:**__ https://discord.gg/MTpT2US`);
}
...
client.guilds.find("id","542919660484427777").channels.find("name","reports").send(sEmbed);
